...
class ParsingEdgeCaseTest extends PHPUnit_Framework_TestCase {
	...
	public function testRandomBracketsInWellformedCode() {
		$this->assertProduces('[b][[][[i]heh[/i][/b]', '<strong>[[][<em>heh</em></strong>');
	}
	...
	public function testUnclosedWithinClosed() {
		$this->assertProduces('[url=http://jbbcode.com][b]oh yeah[/url]', '<a href="http://jbbcode.com"><strong>oh yeah</strong></a>');
	}
	...
	public function testHalfOpenTag() {
		...
		$this->assertProduces('wut [url=http://jbbcode.com', 'wut [url=http://jbbcode.com');
	}
	...
	public function testHalfClosingTag() {
		$this->assertProduces('[b]this should be bold[/b', '<strong>this should be bold[/b</strong>');
	}
	...
	public function testLeftBracketsThenTag() {
		$this->assertProduces('[[[[[b]bold![/b]', '[[[[<strong>bold!</strong>');
	}

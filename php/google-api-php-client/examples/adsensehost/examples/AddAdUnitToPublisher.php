...
class AddAdUnitToPublisher extends BaseExample {
	...
	public function render() {
		...
		$mainFormat = 'Ad unit w/ ID "%s", type "%s", name "%s" and status "%s" was created.';
		$content = sprintf($mainFormat, $result['id'], $result['contentAdsSettings']['type'], $result['name'], $result['status']);
		print $content;
	}

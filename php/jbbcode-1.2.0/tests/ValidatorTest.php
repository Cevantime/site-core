...
class ValidatorTest extends PHPUnit_Framework_TestCase {
	...
	public function testInvalidOptionUrlBBCode() {
		...
		$this->assertEquals('[url=javascript:alert("HACKED!");]click me[/url]', $parser->getAsHtml());
	}
	...
	public function testValidUrlBBCode() {
		...
		$this->assertEquals('<a href="http://jbbcode.com">http://jbbcode.com</a>', $parser->getAsHtml());
	}
	...
	public function testValidColorBBCode() {
		...
		$this->assertEquals('<span style="color: red">colorful text</span>', $parser->getAsHtml());
